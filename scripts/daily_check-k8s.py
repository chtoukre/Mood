...
def ajouter_a_postgres(date_str, entry):
    try:
        conn = psycopg2.connect(
            host="localhost",       # ou l’IP de ton service PostgreSQL dans Minikube
            port=5432,
            dbname="moodtracker",
            user="mooduser",
            password="moodpass"
        ...
        print("❌ Erreur lors de l’insertion PostgreSQL :", e)
...
def main():
    ...
    ajouter_a_postgres(today, entry)
